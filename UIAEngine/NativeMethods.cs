...
namespace XiaoYu_LAM.UIAEngine
{
    ...
    internal static class NativeMethods
    {
        ...
        [DllImport("user32.dll")]
        public static extern bool PrintWindow(IntPtr hwnd, IntPtr hdcDrawing, uint nFlags); [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool GetWindowRect(IntPtr hWnd, out RECT lpRect);

        public delegate bool EnumWindowsProc(IntPtr hWnd, IntPtr lParam); [ComImport, Guid("00021401-0000-0000-C000-000000000046")]
