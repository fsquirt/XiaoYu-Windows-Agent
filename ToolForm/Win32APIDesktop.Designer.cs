namespace XiaoYu_LAM.ToolForm
{
    partial class Win32APIDesktop
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "沟槽的Indiadows11，在非Default桌面启动UWP应用有概率导致所有UWP应用损坏!!";
            // 
            // label2
            // 
            ...
            this.label2.Text = "如果你在主力Windows11/10机器上试图使用这个窗口调试多桌面，后果我已经告诉你了";
            // 
            // Win32APIDesktop
            // 
